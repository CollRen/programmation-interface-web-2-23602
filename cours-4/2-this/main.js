window.addEventListener("DOMContentLoaded", function () {
    let css =
        "color: white; font-size: 14px; font-weight: bold; padding: 15px 0;";
    ...
    document.querySelector("[data-js-btn]").addEventListener(
        "click",
        function () {
            console.log(this);
        }.bind(this)
    ...
    function Cellulaire(nom, prix, compagnie) {
        Produit.call(this, nom, prix); // call([contexte], [les éléments importés de ce contexte], [Un autre élément imporé de ce contexte])
        this.compagnie = compagnie;
    }

    function Laptop(nom, prix, os) {
        Produit.call(this, nom, prix); // Donc, dans le contexte Laptop, utilise this.nom et this.prix qui proviennent de Produit.
        this.os = os;
    }
});
