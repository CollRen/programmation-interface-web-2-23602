...
function connexionDB()
{
	...
	define('DB_NAME', 'ligue-async');
	define('DB_PORT', '3306');


	$laConnexion = mysqli_connect(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME, DB_PORT);
	//$laConnexion = mysqli_connect('localhost', 'root', 'root', 'ligue-async', '3306');
